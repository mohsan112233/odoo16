...
class TrialBalanceReportWizard(models.TransientModel):
    ...
    def onchange_company_id(self):
        ...
        if not self.company_id:
            ...
            if self.category_id:
                res["domain"]["category_id"] += self.category_id
    ...
    def _prepare_report_trial_balance(self):
        ...
        return {
            ...
            "partner_ids": self.partner_ids.ids + self.category_id.partner_ids.ids or [],
            # "category_ids": self.category_id.partner_ids.ids or [],
