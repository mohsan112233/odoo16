...
class FullPayment(models.Model):
    _name = 'hr.full.payment'
    _description = "Employee Advance Salary Full payment"
    ...
    advance_salary_id = fields.Many2one('hr.advance.salary', 'Advance Salary', domain="[('state','=', 'paid')]", required=True, track_visibility='onchange')
    ...
    def unlink(self):
        ...
        return super(FullPayment, self).unlink()
