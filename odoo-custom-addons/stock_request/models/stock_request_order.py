...
class StockRequestOrder(models.Model):
    ...
    def onchange_location_id(self):
        if self.location_id:
            loc_wh = self.location_id._compute_warehouse_id()
    ...
    def action_confirm(self):
        ...
        for i in self.stock_request_ids:
            i.expected_date = self.expected_date
            i.picking_policy = self.picking_policy
            i.warehouse_id = self.warehouse_id.id
            i.location_id = self.location_id.id
            i.procurement_group_id = self.procurement_group_id.id
