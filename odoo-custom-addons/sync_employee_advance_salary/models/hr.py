...
class HrJob(models.Model):
    ...
    advance_salary_limit = fields.Float('Advance Salary Limit')

    @api.onchange('advance_salary_limit')
    def onchange_advance_salary_limit(self):
        if self.advance_salary_limit < 0 or self.advance_salary_limit > 1000000000000000:
            raise ValidationError(_("Advance salary limit Range 0 to 1000000000000000."))
