        ...
        for r in self:
            ...
            for attendance in attendance_data:
                ...
                if user_id:
                    ...
                    device_users = self.env['attendance.wizard'].search([('time_date', '!=', False)])
                    ...
                    if not duplicate_attend and str_utc_timestamp > time_date:
                        ...
                        users = self.env['user.attendance'].search([('user_id', '=', user_id.id),
                                                                    ('timestamp', '>=', time_date)])
                        cont = 0
                        reduce_date = 1
                        if users:
                        ...
                        for user in users:
                            ...
                            if len(users) >= 2 and len(users) % 2 == 0:
                                ...
                                if count_18 < 0:
                                    ...
                                    break
                        if reduce_date == 1:
                            id = DeviceUserAttendance.create(vals)
